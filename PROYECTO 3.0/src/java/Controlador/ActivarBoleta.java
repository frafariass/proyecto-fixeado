 ...
 * @author lordp
 */
@WebServlet(name = "ActivarBoleta", urlPatterns = {"/ActivarBoleta"})
public class ActivarBoleta extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            try
            {
                ...
                bd.update(q);
                bd.cerrarConexion();
                Mensaje mensaje = new Mensaje("Venta activada exitosamente", "venbuscar.jsp", "&laquo; Volver");
